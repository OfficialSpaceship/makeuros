...
SERVICES = {
    ...
    "filebrowser": lambda: setup_docker_compose("filebrowser", "hurlenko/filebrowser:latest", 8080, "filebrowser"),
    "karakeep": lambda: setup_docker_compose("karakeep", "ghcr.io/karakeep-app/karakeep:release", 3060, "karakeep"),
